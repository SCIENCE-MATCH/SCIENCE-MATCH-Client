...
import useGetChapters from "../../../../../libs/apis/Admin/postGetChapters";

const ChapterForAddBook = ({
  currentChapter,
  setCurrentChapter,
  questionCategory,
  setQuestionCategory,
                ...
                <div>
                  {thisChap.children.map((childChap, cIndex) => (
                    <div key={cIndex}>
                      ...
                      {childChap.expansion ? (
                        <div>
                          {childChap.children.map((grandchildChap) => ChapterBox(grandchildChap, 3, childChap.id))}
                        </div>
                      ) : null}
                    </div>
                  ))}
...
export default ChapterForAddBook;
