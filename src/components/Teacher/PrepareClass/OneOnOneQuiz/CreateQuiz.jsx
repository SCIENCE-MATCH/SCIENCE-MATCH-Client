...
const CreateQuiz = ({ goBack }) => {
  ...
  return (
    <OO.Wrapper>
      <ChapterForQuiz
        currentChapter={chapToAdd}
        setCurrentChapter={setChapToAdd}
        school={school}
        setSchool={setSchool}
        grade={grade}
        setGrade={setGrade}
      ...
      <RQ.Wrapper>
        ...
        <RQ.ChapterLine>
          ...
          <RQ.AddBtn onClick={uploadQuiz} disabled={!chapToAdd.id || !question || !answer || !teacherName}>
            문제 추가
          </RQ.AddBtn>
        </RQ.ChapterLine>
        <RQ.AnswerLine>
