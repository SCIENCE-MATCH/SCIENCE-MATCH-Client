...
const PresentQuiz = ({ closeModal, questionText, quizId }) => {
  ...
  return (
    <CTEAM.ModalOverlay>
      <CTEAM.Modal>
        <CTEAM.TitleLine>
          <CTEAM.Title>1:1 질문 {!questionText && `일괄 `}출제하기</CTEAM.Title>
          <STUDandTEAMSELECTER.NumberLabel>질문 {quizId.length}개</STUDandTEAMSELECTER.NumberLabel>
        </CTEAM.TitleLine>
        {questionText && (
          <CTEAM.ContentLine>
            <CTEAM.TextLabel>질문 개요</CTEAM.TextLabel>
        ...
        <CTEAM.BtnLine>
          ...
          <CTEAM.SubmitBtn onClick={presentOneQuiz} disabled={selectedStudIds.length == 0}>
            출제하기
          </CTEAM.SubmitBtn>
        </CTEAM.BtnLine>
      </CTEAM.Modal>
