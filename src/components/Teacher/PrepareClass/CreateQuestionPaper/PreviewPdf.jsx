      ...
      <MODAL.Modal>
        ...
        <MODAL.ContentContainer>
          <VIEWPDF.Wrapper>
            ...
            <VIEWPDF.Navigation>
              <VIEWPDF.NavigateBtn onClick={() => (pageNumber > 1 ? setNum(pageNumber - 1) : null)}>
                <FontAwesomeIcon icon={faCaretLeft} />
              </VIEWPDF.NavigateBtn>
              <VIEWPDF.NavigateBtn onClick={() => (pageNumber < numPages ? setNum(pageNumber + 1) : null)}>
...
const VIEWPDF = {
  ...
  NavigateBtn: styled.div`
    ...
    cursor: pointer;
    &:hover {
      background: rgba(0, 0, 0, 0.3); /* 50% 불투명도 설정 */
      color: black;
      font-size: 7rem;
    }
  `,
