    ...
    <div className={Styles.chapterSection}>
      <div className={Styles.selectionBox}>
        {schoolOption.map((opt) => (
          <div
            className={`${Styles.selectionOpt0} ${selectedSchool === opt ? Styles.selectedOpt : Styles.nonSelectedOpt}`}
            onClick={() => {
          ...
          ? optionForElementary.map((detail) => (
              <div
                className={`${Styles.selectionOpt0} ${
                  selectedGrade === detail ? Styles.selectedOpt : Styles.nonSelectedOpt
                }`}
                onClick={() => {
                  gradeClick(detail);
                }}
      ...
      <div className={Styles.selectionBox}>
        {semesterOption.map((detail) => (
          <div
            className={`${Styles.selectionOpt0} ${
              selectedSemester === detail ? Styles.selectedOpt : Styles.nonSelectedOpt
            }`}
            onClick={() => {
