...
const ManageStudent = () => {
  ...
  return (
    ...
    >
      ...
      >
        <button
          className={searchGrade === "전체" ? Styles.selectedGrade : Styles.gradeBtn}
          onClick={() => {
            setSearchGrade("전체");
          }}
        >
        ...
        <button
          className={searchGrade === "초" ? Styles.selectedGrade : Styles.gradeBtn}
          onClick={() => {
            setSearchGrade("초");
          }}
        >
        ...
        <button
          className={searchGrade === "중" ? Styles.selectedGrade : Styles.gradeBtn}
          onClick={() => {
            setSearchGrade("중");
          }}
        >
        ...
        <button
          className={searchGrade === "고" ? Styles.selectedGrade : Styles.gradeBtn}
          onClick={() => {
            setSearchGrade("고");
          }}
        >
        ...
        <button
          className={searchDeleted === false ? Styles.selectedGrade : Styles.gradeBtn}
          onClick={() => {
