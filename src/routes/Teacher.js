...
import TopTab from "./teacherRoutes/TopTab";
import SubTabs from "./teacherRoutes/SubTabs";
import MyPage from "./teacherRoutes/MyPage";
import ManageStudent from "./teacherRoutes/ManageStudent";
import colors from "../components/Colors.module.css";
import { getCookie } from "../cookie";

const Teacher = ({}) => {
  console.log(`I'm working on Teacher.js`);
